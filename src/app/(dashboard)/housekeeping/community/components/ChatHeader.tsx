          ...
          <div className="flex items-center gap-2">
            {availableProperties.length > 1 ? (
              <div className="relative">
                ...
                >
                  <h2 className="text-base sm:text-lg font-black tracking-tight truncate max-w-[200px] sm:max-w-xs">
      ...
      <div className="flex items-center gap-2 shrink-0 self-end md:self-center">
        ...
        {isAdmin && onOpenCreateAnnouncement && (
          <button
            ...
            className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-amber-500/40 bg-amber-500/15 hover:bg-amber-500/25 text-amber-700 dark:text-amber-300 text-xs font-bold transition-all shadow-xs active:scale-95"
        ...
        {/* Official Announcements Link */}
        <Link
          href="/community/announcements"
          className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-border/80 bg-muted/50 hover:bg-muted text-foreground text-xs font-bold transition-all shadow-xs"
          title="Lihat Pengumuman Resmi Pengelola"
        >
          <IconSpeakerphone className="h-4 w-4 text-amber-500" />
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-[#8FA28A] hover:bg-[#7D9178] text-white text-xs font-bold transition-all shadow-xs active:scale-95"
          title="Daftar Penghuni & Pengelola"
        >
          <IconUsers className="h-4 w-4" />
          <span>Daftar Warga</span>
          <span className="ml-0.5 px-1.5 py-0.2 rounded-full bg-white/20 text-[11px]">
            {activeTenantsCount}
          </span>
        </button>
        ...
        <button
          onClick={onRefresh}
          disabled={refreshing}
          className="p-2 rounded-xl border border-border/80 bg-card hover:bg-muted text-foreground transition-all disabled:opacity-50"
