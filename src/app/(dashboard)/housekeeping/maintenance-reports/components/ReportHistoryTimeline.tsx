        ...
        {timeline.map((log, index) => {
          ...
          return (
            <div key={log.id} className="relative group">
              ...
              {/* Log Card Box */}
              <div className="p-3.5 rounded-xl border border-gray-200 bg-white shadow-sm space-y-2 text-xs">
                ...
                {/* Notes */}
                <p className="text-[11px] text-gray-600 leading-relaxed font-medium bg-gray-50 p-2.5 rounded-lg border border-gray-100">
                  "{log.notes}"
                </p>
